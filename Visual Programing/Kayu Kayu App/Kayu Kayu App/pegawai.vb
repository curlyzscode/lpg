...
Public Class pegawai
    ...
    Private Sub statusinput(username As Boolean, password As Boolean, status As Boolean, nama As Boolean, bagian As Boolean, jeniskelamin As Boolean, tempatlahir As Boolean, tanggallahir As Boolean, alamat As Boolean, nohp As Boolean)
    ...
    Private Sub tampildata()
        ...
        query = "select username, password, status, nama_user, bagian, jenis_kelamin, tempat_lahir, tanggal_lahir, alamat, no_hp from user "
    ...
    Private Sub btnTambah_Click(sender As Object, e As EventArgs) Handles btnTambah.Click
        ...
        statusinput(True, True, True, True, True, True, True, True, True, True)
        txtUsername.Focus()
    ...
    Private Sub btnSimpan_Click(sender As Object, e As EventArgs) Handles btnSimpan.Click
        ...
        Try
            ...
            qInsert = "insert into user (username, password, status, nama_user, bagian, jenis_kelamin, tempat_lahir, tanggal_lahir, alamat, no_hp) VALUES ('" & txtUsername.Text & "', '" & txtPassword.Text & "', '" & cmbStatus.Text & "', '" & txtNamaPegawai.Text & "','" & cmbBagian.Text & "', '" & cmbJenisKelamin.Text & "','" & txtTempatLahir.Text & "', '" & dtpTanggalLahir.Value.ToString("yyyy-MM-dd") & "', '" & txtAlamat.Text & "', '" & txtNoHp.Text & "')"
